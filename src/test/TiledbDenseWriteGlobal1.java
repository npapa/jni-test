...
public class TiledbDenseWriteGlobal1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("OK");
		  ...
		  intArray a2 = ArrayUtils.newIntArray(buffer_a2);
...
//		  void* buffers[] = {buffer_a1, buffer_a2, buffer_var_a2, buffer_a3};
		  int buffer_sizes[] = {
		      buffer_a1.length,
		      buffer_a2.length,
		      buffer_var_a2.length(),  // No need to store the last '\0' character
		      buffer_a3.length};
		  uint64_tArray buffer_sizes_ = ArrayUtils.newUint64Array(buffer_sizes);
...
System.out.println("OK");
		  ...
		  System.out.println("value: "+tiledb.charpArray_getitem(attributes, 0));
//		  String[] attributes = {"a1", "a2", "a3"};
		  tiledb.tiledb_query_create(ctx, querypp, "my_dense_array1", tiledb_query_type_t.TILEDB_WRITE);
...
System.out.println("OK");
		  tiledb.tiledb_query_set_buffers(ctx, query, attributes, 3, buffers, buffer_sizes_.cast());
