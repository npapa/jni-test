...
public class TiledbDenseCreate {
	...
	public static void main(String[] args) {
		...
		tiledb.tiledb_attribute_set_compressor(ctx, a3, tiledb_compressor_t.TILEDB_ZSTD, -1);
		...
		tiledb.tiledb_array_schema_create(ctx, array_schemapp, tiledb_array_type_t.TILEDB_DENSE);
		tiledb_array_schema_t array_schema = tiledb.tiledb_array_schema_tpp_value(array_schemapp);
